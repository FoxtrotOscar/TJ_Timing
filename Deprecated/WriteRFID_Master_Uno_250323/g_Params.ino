...
/* nameParam[13] = {"Time" 0,8; "Walk" 1,2; "Ends" 2,byte<20; "Dets" 3,2; "Prac" 4,4; "Fnls" 5,bool; 
                    "BrkT" 6,255; "Altr" 7,bool; "Team" 8,teamParam[15] ; "A/B?" 9,bool; "Flnt" 10,bool;
                    "Supv" 11, bool; "IFAA" 12,bool; "Bann" 13,bool} */
  uint8_t tempVal;
        ...
        switch (waitButton()) {
          case BUTTON1:
            ...
            if (tempVal) {              // if Flint
              ...
              dataStore[2] =  7;        // end count == 7
              dataStore[3] =  1;        // detail = 1
              dataStore[6] = 15;        // timer: 15min
