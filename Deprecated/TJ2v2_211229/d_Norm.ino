...
*/
  ...
  while (continueOn && !startOver) {
    ...
    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++        
    while(n_Count >= 0 && !startOver){                          // Handle the count-down
    ...
    if (!startOver) {
      ...
      if(paramStore.Details == 2 && sE_iter%2 == 1){              // now test for NEXT or HALT
        ...
        n_Count = paramStore.walkUp;                              // setup count for the bar-graph
        ...
        if (paramStore.Details == 2){                            // Double detail?
          sendSerialS( /*colour(R1G2O3)=*/ 3, /*column=*/ 44, /*line=*/ lnNumber, 
                      !countPractice ? (sE_iter%4 == 1 ? "C D" : "A B") : (sE_iter%2 == 0 ? "A B" : "C D")) ;
                      // if practice seq. then details do not flip, otherwise flip
        }
